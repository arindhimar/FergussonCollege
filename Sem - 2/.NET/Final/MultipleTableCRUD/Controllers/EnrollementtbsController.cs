...
using MultipleTableCRUD.Models;

namespace MultipleTableCRUD.Controllers
{
    public class EnrollementtbsController : Controller
    {
        ...
        {
            ViewData["Cid"] = new SelectList(_context.Coursestbs, "Cid", "Cname");

            // Concatenating First Name and Last Name
            ViewData["Sid"] = new SelectList(
                _context.Studenttbs.Select(s => new
                {
                    Sid = s.Sid,
