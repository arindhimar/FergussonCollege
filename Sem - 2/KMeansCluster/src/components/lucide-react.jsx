// This file contains custom implementations of Lucide React icons
// since we're not using npm packages in this example
...
export function ChevronDownIcon(props) {
  ...
  export function ScatterChartIcon(props) {
    return (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="24"
