...
class State {
    ...
    State(int jug1Cap, int jug2Cap, String actions) {
...
private static void solveUsingBFS() {
    ...
    private static List<State> generateNextStates(State currentState) {
        ...
        if (currentState.jug1Cap < jug1.getMaxCap()) {
            nextStates.add(new State(jug1.getMaxCap(), currentState.jug2Cap, currentState.actions + "Fill Jug1 "));
        }

        // Fill Jug2
        if (currentState.jug2Cap < jug2.getMaxCap()) {
            nextStates.add(new State(currentState.jug1Cap, jug2.getMaxCap(), currentState.actions + "Fill Jug2 "));
        }

        // Empty Jug1
        if (currentState.jug1Cap > 0) {
            nextStates.add(new State(0, currentState.jug2Cap, currentState.actions + "Empty Jug1 "));
        }

        // Empty Jug2
        if (currentState.jug2Cap > 0) { 
            nextStates.add(new State(currentState.jug1Cap, 0, currentState.actions + "Empty Jug2 "));
        }
        ...
        if (currentState.jug1Cap > 0 && currentState.jug2Cap < jug2.getMaxCap()) {
            ...
            nextStates.add(new State(currentState.jug1Cap - transferAmount, currentState.jug2Cap + transferAmount, currentState.actions + "Transfer Jug1 to Jug2 "));
        }
        ...
        if (currentState.jug2Cap > 0 && currentState.jug1Cap < jug1.getMaxCap()) {
            ...
            nextStates.add(new State(currentState.jug1Cap + transferAmount, currentState.jug2Cap - transferAmount, currentState.actions + "Transfer Jug2 to Jug1 "));
        }
