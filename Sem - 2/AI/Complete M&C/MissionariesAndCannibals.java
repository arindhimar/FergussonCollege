...
class State {
    ...
    // Heuristic function to prioritize closer states to the goal (best first search).
    public int heuristic() {
        return leftMissionaries + leftCannibals;  // Number of people left on the wrong bank
    }
}
...
class MissionariesAndCannibalsGame {
    ...
    public void startGame() {
        ...
        while (true) {
            ...
            System.out.println("7. Solve using Best First Search.");
            ...
            switch (choice) {
                ...
                case 7 -> solveUsingBestFirstSearch();
                case 8 -> {
    ...
    private void solveUsingBestFirstSearch() {
        System.out.println("\nSolving using Best First Search...");

        PriorityQueue<State> pq = new PriorityQueue<>(Comparator.comparingInt(State::heuristic));
        Set<String> visited = new HashSet<>();
